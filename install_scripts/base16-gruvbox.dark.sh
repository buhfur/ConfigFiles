#!/usr/bin/env bash
# Base16 Gruvbox - Gnome Terminal color scheme install script
...
gset string palette "#282828:#cc241d:#98971a:#d79921:#458588:#b16286:#689d6a:#d5c4a1:#ebdbb2:#cc241d:#98971a:#d79921:#458588:#b16286:#689d6a:#fbf1c7"
